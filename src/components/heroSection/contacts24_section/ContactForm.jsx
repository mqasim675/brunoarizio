    ...
    <div className="w-full">
      <div className="flex justify-between w-[80%] mx-auto">
        <div className="w-1/2 pt-12">
          ...
          <div className="pt-5">
            ...
            <a
              ...
              className=""
            >
              <div className="flex items-center leading-3 pt-6 ">
                <div className="text-[10px] generalbruno flex">
            ...
            <a
              href="https://www.behance.net/brunoarizio"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="http://dribbble.com/brunoarizio"
              target="_blank"
              rel="noreferrer"
            >
              <p className="flex items-center leading-3">
            ...
            <a
              href="https://www.instagram.com/brunoarizio/"
              target="_blank"
              rel="noreferrer"
            >
              <p className="flex items-center leading-3">
            ...
            <a
              href="https://www.linkedin.com/in/brunoarizio/"
              target="_blank"
              rel="noreferrer"
            >
              <p className="flex items-center leading-3">
            ...
            <a
              href="https://medium.com/@brunoarizio"
              target="_blank"
              rel="noreferrer"
            >
              <p className="flex items-center leading-3">
        ...
        <div className="w-1/2 pt-12">
          <div className="w-full">
            <div>
              <h3 className="text-[22px]">Office</h3>
              <p className="text-[14px] mt-[10px]">
                71-75 Shelton Street, Covent <br /> Garden, London, WC2H 9JQ
              </p>
            </div>
            <div className="pt-1">
              <h3 className="text-[22px]">Careers</h3>
              <p className="text-[14px] mt-[10px]">
                {" "}
